...
Reply in whichever medium the note arrived in, and only that one. A note came
in through the page, not the chat — answer it with `reply.ts`, in its thread,
and leave the chat conversation alone. Saying the same thing twice, once in
the thread and again in chat, isn't thorough, it's just confusing.
